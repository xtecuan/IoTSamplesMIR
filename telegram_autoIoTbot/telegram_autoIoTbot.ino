...
String ssid = "Xtecuannet";     // REPLACE mySSID WITH YOUR WIFI SSID
String pass = "X4tecuan$"; // REPLACE myPassword YOUR WIFI PASSWORD, IF ANY
String token = "1723433441:AAGI4TRFyvXIVkO1F9kKtRGkYH4DnjbOaV0";   // REPLACE myToken WITH YOUR TELEGRAM BOT TOKEN
